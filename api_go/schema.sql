...
--
ALTER TABLE `authors`
    ADD CONSTRAINT `FKl3fvy5sfb7c0c7om0c7hwpxc4` FOREIGN KEY (`user_id_fk`) REFERENCES `user` (`user_id`);

--
-- Constraints der Tabelle `concert`
--
ALTER TABLE `concert`
    ADD CONSTRAINT `FK5wexqlvcj6jturp80sbm0vbjl` FOREIGN KEY (`user_id_fk`) REFERENCES `user` (`user_id`);
...
ALTER TABLE `elements`
    ...
    ADD CONSTRAINT `FKd8vh3jac37jvfu6ab0gcfvqs5` FOREIGN KEY (`user_id_fk`) REFERENCES `user` (`user_id`);
