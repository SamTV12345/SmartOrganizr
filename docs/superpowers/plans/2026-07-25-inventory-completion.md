...
- [ ] **Step 2: Run and watch it fail** — Feld fehlt, JSON hat keinen `inventoryNo`.

- [ ] **Step 3: Add the field and populate it in LastSeen and Lookup**
...
- [ ] **Step 3: Run and watch it fail** — `cd ui && pnpm test QrCode`, Modul existiert nicht.
...
- [ ] **Step 1: Folder search in the inventory screen**
...
- [ ] **Step 3: Entry point on the folder**
...
- [ ] **Step 3: Report-Einträge verlinken**
