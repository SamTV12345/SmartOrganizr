...
export const AddModal:FC<ModalProps>  = ({headerText,children, onAccept,acceptText})=>{
    ...
    return  openModal ? createPortal(
        <div id="defaultModal" onClick={()=>dispatch(setOpenAddModal(false))} tabIndex={-1} aria-hidden="true" className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
